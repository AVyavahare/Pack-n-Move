				...
				<form action="#" method="post">
					...
					<div class="col-md-12 wthree_contact_left_grid" style="padding-top: 20px">
						<strong style="padding-right: 20px">What do you want to shift?</strong><select type="text" name="bitems" value="What do you want to shift?*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject*';}" required="true">
							...
							<option value="Very Few items(rs1000-rs1500)">Very Few items(rs1000-rs1500)</option>
							<option value="1 BHK80(rs5000-rs7500)">1 BHK(rs5000-rs7500)</option>
							<option value="Very Few items(rs10000-rs12000)">2 BHK(rs10000-rs12000)</option>
							<option value="Very Few items(rs15000-rs17000)">3 BHK(rs15000-rs17000)</option>
						</select>
					</div>
					<div class="col-md-12 wthree_contact_left_grid" style="padding-top: 20px">
